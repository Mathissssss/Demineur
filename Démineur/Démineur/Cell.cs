    ...
    public class Cell
    {
        ...
        public static int CountDiscoveredBombs(Board board, int x, int y)
        {
            ...
            if (x == 0)
            {
                if (y == 0)
                {
                    if (board.BoardArray[x, y + 1].State == CellState.Flag &&
                        board.BoardArray[x, y + 1].Type == CellType.Bomb)
                    {
                        count += 1;
                    }

                    if (board.BoardArray[x + 1, y + 1].State == CellState.Flag &&
                        board.BoardArray[x + 1, y + 1].Type == CellType.Bomb)
                    {
                        count += 1;
                    }

                    if (board.BoardArray[x + 1, y].State == CellState.Flag &&
                        board.BoardArray[x + 1, y].Type == CellType.Bomb)
                    {
                        count++;
                    }
                }
        ...
        public static void Help_Discover(Board board, int x, int y)
        {
            board.BoardArray[x, y].State = CellState.Discovered;
            if (board.BoardArray[x, y].Type == CellType.Empty)
            {
                Empty(board, x, y);
            }
        }
        ...
        public static void Help_Empty(Board board, int x, int y)
        {
            board.BoardArray[x, y].State = CellState.Discovered;
            Empty(board, x, y);
        }
